...
uint8_t Array_UART7_RX [Length_UART7_RX_Buff];
uint8_t Array_UART8_RX [Length_UART8_RX_Buff];
...
uint8_t Array_UART7_TX [Length_UART7_TX_Buff];
uint8_t Array_UART8_TX [Length_UART8_TX_Buff];
