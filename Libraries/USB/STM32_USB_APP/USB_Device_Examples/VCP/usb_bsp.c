...
* @retval None
*/
extern uint8_t usbPreemptionPriority, usbSubPriority;
...
#endif
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = usbPreemptionPriority;
  NVIC_InitStructure.NVIC_IRQChannelSubPriority = usbSubPriority;
