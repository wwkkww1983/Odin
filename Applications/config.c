...
void configLoadDefault(void){
	...
	parameter[SHOOT_FRIC_P] = DEFAULT_SHOOT_SPEED_P;
	parameter[SHOOT_FRIC_I] = DEFAULT_SHOOT_SPEED_I;
	parameter[SHOOT_FRIC_D] = DEFAULT_SHOOT_SPEED_D;
	parameter[SHOOT_FRIC_F] = DEFAULT_SHOOT_SPEED_F;
	parameter[SHOOT_FRIC_PM] = DEFAULT_SHOOT_SPEED_PM;
	parameter[SHOOT_FRIC_IM] = DEFAULT_SHOOT_SPEED_IM;
	parameter[SHOOT_FRIC_DM] = DEFAULT_SHOOT_SPEED_DM;
	parameter[SHOOT_FRIC_OM] = DEFAULT_SHOOT_SPEED_OM;	
	
	parameter[SHOOT_DIAL_L_P] = DEFAULT_ROLLBULL_SPEED_P;
	parameter[SHOOT_DIAL_L_I] = DEFAULT_ROLLBULL_SPEED_I;
	parameter[SHOOT_DIAL_L_D] = DEFAULT_ROLLBULL_SPEED_D;
	parameter[SHOOT_DIAL_L_F] = DEFAULT_ROLLBULL_SPEED_F;
	parameter[SHOOT_DIAL_L_PM] = DEFAULT_ROLLBULL_SPEED_PM;
	parameter[SHOOT_DIAL_L_IM] = DEFAULT_ROLLBULL_SPEED_IM;
	parameter[SHOOT_DIAL_L_DM] = DEFAULT_ROLLBULL_SPEED_DM;
	parameter[SHOOT_DIAL_L_OM] = DEFAULT_ROLLBULL_SPEED_OM;
	
	parameter[SHOOT_DIAL_S_P] = DEFAULT_LOADED_SPEED_P;
	parameter[SHOOT_DIAL_S_I] = DEFAULT_LOADED_SPEED_I;
	parameter[SHOOT_DIAL_S_D] = DEFAULT_LOADED_SPEED_D;
	parameter[SHOOT_DIAL_S_F] = DEFAULT_LOADED_SPEED_F;
	parameter[SHOOT_DIAL_S_PM] = DEFAULT_LOADED_SPEED_PM;
	parameter[SHOOT_DIAL_S_IM] = DEFAULT_LOADED_SPEED_IM;
	parameter[SHOOT_DIAL_S_DM] = DEFAULT_LOADED_SPEED_DM;
	parameter[SHOOT_DIAL_S_OM] = DEFAULT_LOADED_SPEED_OM;			
